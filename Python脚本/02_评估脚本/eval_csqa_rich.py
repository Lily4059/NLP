...
def build_prompt(tokenizer, instruction: str, input_text: str) -> str:
    # Base models are often more verbose than instruct models, so we add a
    # stronger output constraint to make evaluation more stable.
...
def parse_args():
    parser = argparse.ArgumentParser(description="Rich evaluation for CSQA-style multiple-choice generation.")
