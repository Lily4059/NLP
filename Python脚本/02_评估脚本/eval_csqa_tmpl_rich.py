...
CHOICES = ["A", "B", "C", "D", "E"]
ANSWER_PATTERNS = [
    re.compile(r"THE CORRECT ANSWER IS\s*[\(\[]?\s*([A-E])\b"),
...
def extract_choice(text: str) -> str:
    ...
    # Only trust explicit answer templates in this route. The first matched
    # template is treated as the model's final answer.
...
def parse_args():
    parser = argparse.ArgumentParser(description="Rich evaluation for the CSQA template-answer route.")
